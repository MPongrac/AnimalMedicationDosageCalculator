var lbl_amt_med_per_weight = 0.005;
...
function compute_totals() {
  ...
  val_total_medicine = 1 * val_total_weight * lbl_amt_med_per_weight;
...
function show_totals() {
  ...
  $('#result_total_medication').html(val_total_medicine.toFixed(4));
}
